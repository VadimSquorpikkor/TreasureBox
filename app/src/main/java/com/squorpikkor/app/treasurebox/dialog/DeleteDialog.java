...
public class DeleteDialog extends BaseDialog{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ((TextView)view.findViewById(R.id.delete_text)).setText(String.format("Элемент %s будет удален из БД навсегда", Encrypter2.decrypt(mViewModel.getLogin(), entityName)));
